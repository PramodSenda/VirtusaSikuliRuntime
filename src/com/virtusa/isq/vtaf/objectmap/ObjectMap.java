...
public class ObjectMap {
    ...
    public static String getObjectSearchPath(final String objectName,
        ...
        try {
            ...
            searchPath = "src" + java.io.File.separator + "main" + java.io.File.separator + "resources" 
                        + java.io.File.separator + "ObjectMaps" + java.io.File.separator + pageName
                    + java.io.File.separator + searchPath;
            } 
